...
module.exports = ctxMock => {
  ...
  expect(ctxMock.metric.increment.mock.calls[3]).toEqual([
    "ship.service_api.call",
    1,
    [
      "method:GET",
      "url:https://app.close.io/api/v1/activity/email/",
      "status:200",
      "statusGroup:2xx",
      "endpoint:GET https://app.close.io/api/v1/activity/email/"
    ]
  ]);

  expect(ctxMock.client.logger.debug.mock.calls).toHaveLength(4); // debug calls from super-agent
